        ...
        GlobalScope.launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                when (response) {
                    ...
                    {
                      //  println("Your issue is about flat tyre, Iam giving you some tips to resolve it, Kindly watch the video..")
                        val site = Intent(Intent.ACTION_VIEW)
                        site.data = Uri.parse("https://www.rac.co.uk/drive/advice/car-maintenance/repair-a-flat-tyre/")
                        startActivity(site)
